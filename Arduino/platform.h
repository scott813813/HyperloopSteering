...
#define MIN_POS 0
#define MAX_POS 1024 // 10 bit ADC resolution, can be increased to 12 bit if necessary (4095)
#define MIN_PWM 0
...
#define OFF_THRESHOLD 50  // ignore calibration if motors aren't powered (i.e. large reading difference from default is found)
int16_t ZERO_POS[NUM_MOTORS]  = { 83, 78, 84, 80, 83, 79 }; 
int16_t END_POS[NUM_MOTORS]   = { 943, 934, 940, 936, 941, 937 };
...
const uint8_t POT_PINS[NUM_MOTORS] = { POT_1, POT_2, POT_3, POT_4, POT_5, POT_6 };

// Movement parameters
#define RESET_DELAY 6000      // at full PWM, the actuator should fully extend/retract by 5s (8" stroke, 2.00"/s with minimal load)
...
#define PRINT_INTERVAL          25                // minimum time (ms) between printing serial info
