...
% This script will take in, in variable form, the dimensions of the bottom
% and top of the robot, a and b respectively, the values of the
% theta, phi, and psi, respective to the x, y, and z axis respectively, and
% the position vector P, and output the link lengths of each linear
% actuator. The outputs are then simulated for a predetermined motion
% profile and various metrics are 
...
% Create function based motion per degree of freedom (independently)
