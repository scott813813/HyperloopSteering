classdef StewartPlatformAppApp < handle
    %
    % Usage:
    %     app.StewartPlatformAppApp
    ...
    properties (Constant)
        AppPathBase = {'/StewartPlatformApp'};
        AppClass = 'StewartPlatformAppApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = StewartPlatformAppApp()
        ...
        function startApp(obj)
            ...
            mlock;
            StewartPlatformAppApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'StewartPlatformApp')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong StewartPlatformApp
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'StewartPlatformApp').getString, ...
            ...
            if nargout(@StewartPlatformApp) == 0
                eval('StewartPlatformApp');
            else
                obj.AppHandle = eval('StewartPlatformApp');
            end
